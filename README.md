...
Realize a verificação das ferramtas executando em seu terminal
```
make check-tools
```
...
Este projeto está sob a licença (sua licença) - veja o arquivo [LICENSE.md](https://github.com/lhc/infra/LICENSE.md) para detalhes.
